 ...
 * \return code error
 */
extern int mcp23008_init(device_mcp230xx *mcp23008config);        // PCA9685 driver initialization
 ...
 * \return code error
 */
extern int mcp23017_init(device_mcp230xx *mcp23017config);        // PCA9685 driver initialization
...
extern char actuator_getDigitalInput(device_mcp230xx *mcp230xxconfig, unsigned char channel);
